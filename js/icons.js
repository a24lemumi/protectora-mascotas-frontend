...
function createIcon(name, size = 16, color = 'currentColor') {
    const svg = icons[name];
    if (!svg) return '';
    return `<span class="icon icon-${name}" style="display:inline-flex;width:${size}px;height:${size}px;color:${color}">${svg}</span>`;
}
